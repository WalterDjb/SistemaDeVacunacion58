...
public class QuieroVacunarme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(label_doc, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, -1, -1));
        getContentPane().add(txt_doc, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, 250, -1));
        ...
        getContentPane().add(txt_tramite, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, 250, -1));

        label_tramite.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        label_tramite.setText("Número de trámite:");
        getContentPane().add(label_tramite, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 190, -1, -1));
        ...
        getContentPane().add(jtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, 131, -1));
        ...
        getContentPane().add(jtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 340, 131, -1));
        ...
        getContentPane().add(jtCaracCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 340, 60, -1));
        ...
        getContentPane().add(jtCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 370, 131, -1));

        jLabel11.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        jLabel11.setText("Patología base:");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 380, -1, -1));

        jLabel12.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        jLabel12.setText("Domicilio");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, -1, -1));
        ...
        getContentPane().add(jtAmbito, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 430, 131, -1));

        jLabel14.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        jLabel14.setText("Nombre y apellido");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 220, -1, 20));
        ...
        getContentPane().add(jtNombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 220, 131, -1));

        jLabel15.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        jLabel15.setText("Email:");
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, -1, -1));
        ...
        getContentPane().add(jtEmail1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 280, 131, -1));

        jLabel16.setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        jLabel16.setText("Provincia");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, -1, -1));
        ...
        getContentPane().add(jtEmail2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 310, 131, -1));
        ...
        getContentPane().add(jtAmbito1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 400, 131, -1));
