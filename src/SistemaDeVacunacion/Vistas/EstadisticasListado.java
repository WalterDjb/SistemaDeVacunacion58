...
public class EstadisticasListado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbLista_Diaria.setText("Listado diario de centros y dosis");
        jbLista_Diaria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbLista_DiariaActionPerformed(evt);
            }
        });
        getContentPane().add(jbLista_Diaria, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 280, -1, 41));
        ...
        jbLista_Centro.setText("Listado de centro específico");
...
// TODO add your handling code here:
    ...
    private void jbLista_CentroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbLista_CentroActionPerformed
        this.dispose();
        new ListCitasMensual().setVisible(true);        // TODO add your handling code here:
